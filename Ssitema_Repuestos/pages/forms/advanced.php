...
<head>
  ...
  <title>Sistema Repuestos |Facturacion</title>
...
<div class="wrapper">
 ...
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Mantenimiento Repuestos</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item" style="color:#0056b3;"><a href="#">Inicio</a></li>
                <li class="breadcrumb-item" style="color:#3d3d3d"><b>Facturacion</b></li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="card card-default">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre Cliente</label>
                   <input type="email" class="form-control" id="exampleInputEmail" placeholder="Ingrese Nombre" >
                   <button type="submit" class="btn btn-block btn-info">Buscar</button>
                </div>
              </div>
              <div class="col-md-6">
                 <label for="exampleInputFile">No. 00001</label>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nit</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Ingrese Nit">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Repuesto</label>
                   <input type="email" class="form-control" id="exampleInputEmail" placeholder="Repuesto" >
                   <button type="submit" class="btn btn-block btn-info">Buscar Repuesto</button>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <div class="col-md-6">
                     <label for="exampleInputEmail1">Agregar Cantidad</label>
                    <input id="new-event" type="text" class="form-control" placeholder="Agregar Cantidad">
                  </div>
           
                <div class="col-md-6">
                      <br>
                      <button id="add-new-event" type="button" class="btn btn-block btn-success">+ Agregar Producto a la lista de compra</button>
                  </div>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                      ...
                      <button id="add-new-event" type="button" class="btn btn-primary">+ Guardar</button>
                      <button id="add-new-event" type="button" class="btn btn-warning dropdown-toggle">+/ Guardar e Imprimir</button>
                  </div>
            </div>
          </div>
        </div>  
