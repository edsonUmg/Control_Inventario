...
<head>
  ...
  <title>Sistema Repuestos | Devoluciones</title>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item" style="color:#0056b3;"><a href="#">Inicio</a></li>
                <li class="breadcrumb-item" style="color:#3d3d3d"><b>Devoluciones</b></li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                      <button id="add-new-event" type="button" class="btn btn-warning dropdown-toggle">+/ Buscar Producto</button>
                  </div>
            </div>
          </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                       <label for="exampleInputEmail1">Agregar Producto para Devolucion</label>
                     <center><button type="submit" form="mantenProvee" style="background-color:#3c3c3c" class="btn btn-block btn-success">Agregar Producto</button></center> 
                  </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                 ...
                 <div class="col-md-4">
                      <br>
                     <center><button type="submit" form="mantenProvee" style="background-color:#3c3c3c" class="btn btn-block btn-success">Realizar Devolucion</button></center> 
                  </div>
            </div>
          </div>
        </div>  
