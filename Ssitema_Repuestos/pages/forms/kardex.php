...
<head>
  ...
  <title>Sistema Repuestos |Kardex</title>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item" style="color:#0056b3;"><a href="#">Inicio</a></li>
                ...
                <li class="breadcrumb-item" style="color:#3d3d3d"><b>Kardex</b></li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Codigo del Producto</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Codigo Producto">
                </div>
              </div>
                  <div class="col-md-6">
                <div class="form-group">
                     <label for="exampleInputEmail1">Buscar Codigo </label>
                    <button id="add-new-event" type="button" class="btn btn-block btn-warning">+/Buscar</button>
                </div>
              </div>
                  <div class="col-md-6">
               <div class="form-group">
                 ...
                 <div class="col-md-6">
                <div class="form-group">
                     <label for="exampleInputEmail1">Consultar </label>
                    <button id="add-new-event" type="button" class=" btn btn-block bg-gradient-secondary">+/Consultar Kardex</button>
                </div>
              </div>
            </div>
          </div>
           ...
           <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Codigo</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Codigo">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Existencias Actuales</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Existencias Actuales">
                </div>
              </div>
                   <div class="col-md-6">
                <div class="form-group">
                     <label for="exampleInputEmail1">Exportar Documento a Excel </label>
                     <button id="add-new-event" type="button" class="btn btn-block btn-success">+ Exportar a Excel</button>
                </div>
              </div>
            </div>
          </div>
