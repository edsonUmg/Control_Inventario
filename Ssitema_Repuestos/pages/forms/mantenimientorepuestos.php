...
<head>
  ...
  <title>Sistema Repuestos |Mantenimiento Repuestos</title>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item" style="color:#0056b3;">Mantenimientos</li>
                <li class="breadcrumb-item" style="color:#3d3d3d"><b>Mantenimiento Repuestos</b></li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Datos de Repuestos</h3>
          </div>
          <div class="card-body">
            <div class="row">
           <div class="col-md-6">
                ...
                <div class="col-md-6">
                <div class="form-group">
                        <label>Codigo Tipo Repuesto</label>
                        <select class="form-control">
                          <option>01-llantas</option>
                          <option>02-motor</option>
              ...
              <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Precio 1Q</h3>
            ...
            <div class="row">
                <div class="col-md-6">
                 <div class="form-group">
                        ...
                        <select class="form-control">
                          <option>Precio 1Q</option>
                          <option>Precio 2Q</option>
                          <option>Precio 3Q</option>
                            <option>Precio 4Q</option>
                        </select>
                </div>
              </div>
                  <div class="col-md-6">
