...
<head>
  ...
  <title>Sistema Repuestos |Orden de Compra</title>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item" style="color:#0056b3;"><a href="#">Inicio</a></li>
                 <li class="breadcrumb-item" style="color:#0056b3;">Inventario</li>
                <li class="breadcrumb-item" style="color:#3d3d3d"><b> Orden de Compra</b></li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <button id="add-new-event" type="button" class="btn btn-primary">+ Nuevo</button>
                      <button id="add-new-event" type="button" class="btn btn-warning dropdown-toggle">+/ Guardar</button>
                      <button id="add-new-event" type="button" class="btn btn-danger">x Cancelar</button>
                  </div>
            </div>
          </div>
        <div class="card card-default">
          <div class="card-header">
            ...
            <div class="card-header">
                <h3 class="card-title">El presente documento no figura como documento tributario</h3>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <label for="exampleInputFile">Fecha de la orden de compra</label>
                <div class="form-group">
                        <label>Buscar</label>
                        <select class="form-control">
                          <option>01-Vinicio</option>
                          <option>02-Allan</option>
                          <option>03-Diego</option>
                        </select>
                </div>
              </div>
              <div class="col-md-6">
                 <label for="exampleInputFile">13/10/2020</label>
                <div class="form-group">
                  <label for="exampleInputEmail1">Direccion</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Direccion">
                </div>
              </div>
                  <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nombre</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Nombre">
                </div>
              </div>
                  <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nit</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Nit">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                        <label>Buscar</label>
                        <select class="form-control">
                          <option>01-cluch</option>
                          <option>02-Pastillas</option>
                          <option>03-amortiguadores</option>
                        </select>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Descripcion</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Descripcion">
                </div>
              </div>
                  <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Costo</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Costo">
                </div>
              </div>
                  <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Cantidad</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="Cantidad">   
                </div>
                       <div class="col-md-6">
                      <br>
                      <button id="add-new-event" type="button" class="btn btn-block btn-success">+ Agregar Producto a la lista</button>
                  </div>
              </div>
            </div>
          </div>
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>002</td>
                      <td>Amortiguador Honda Civic</td>
                      <td>1</td>
                      <td>300.00</td>
                      <td>300.00</td>
                    </tr>
      ...
      <div class="col-md-6">
                      <br>
                      <button id="add-new-event" type="button" class="btn btn-block btn-danger btn-lg">x Eliminar Fila</button>
                  </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Total</label>
                    <input type="email" class="form-control" id="exampleInputEmail" placeholder="0.00">
                </div>
              </div>
            </div>
          </div>
