...
<head>
  ...
  <title>Sistema Repuestos |Reporte Repuestos</title>
  ...
  <div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Reporte Repuestos</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item" style="color:#0056b3;"><a href="#">Inicio</a></li>
                 <li class="breadcrumb-item" style="color:#0056b3;">Reportes</li>
                <li class="breadcrumb-item" style="color:#3d3d3d"><b>Reporte Repuestos</b></li>
            </ol>
          </div>
        </div>
      </div>
